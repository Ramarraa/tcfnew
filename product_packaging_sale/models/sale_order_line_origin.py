...
# product_packaging_id/product_packaging_qty field, so this quantity-from-packaging monkey-patch
# has no field to key off. Needs a redesign around the new UoM-based packaging model, not a rename.
